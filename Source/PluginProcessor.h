...
/**
*/
class AapCourseworkAudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    AapCourseworkAudioProcessor();
    ~AapCourseworkAudioProcessor();
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AapCourseworkAudioProcessor)
